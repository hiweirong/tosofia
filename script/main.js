...
const animationTimeline = () => {
  ...
  tl
    ...
    }, "-=0.3") // Start just before the hat animation ends
    .to(".rose", 0.5, {
      scale: 1,
      opacity: 1,
      // Adjust x and y position to ensure final placement
      x: "0%",
      y: "50%",
...
//       opacity: 0
//     })
//     // Adding rose animation after the hat animation
//     .from(".rose", 0.5, {
//       scale: 0.5,
//       opacity: 0,
//       x: "-50%",
